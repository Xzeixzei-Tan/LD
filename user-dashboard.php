...
if (isset($_GET['show_certificate']) && !empty($_GET['show_certificate'])) {
    ...
    $stmt = $conn->prepare("SELECT message FROM notifications WHERE event_id = ? AND notification_subtype = 'certificate' AND notification_subtype = 'evaluation' LIMIT 1");
            ...
            <div class="content-area">
                ...
                <?php while ($event = $result->fetch_assoc()) : ?>    
                    ...
                    <?php if ($result->num_rows == 0): ?>
                            <p style="font-family: Montserrat; color: gray;">No events yet.</p>
                        <?php endif; ?>  
                    </div>
                    <div class="notifications-section">
                            ...
                            <div class="notification <?php echo $notif['is_read'] ? 'read' : 'important'; ?>">
                                ...
                                <?php
                                    ...
                                    if (!empty($notif['event_id']) && $notif['notification_subtype'] == 'new_event') {
                                        ...
                                        $redirect_url = !empty($notif['event_id']) ? 
                                            "user-notif.php?event_id=" . urlencode($notif['event_id']) : 
                                            "user-notif.php";
                                    }
                        ...
                        <?php if ($notif_result->num_rows == 0): ?>
                            <p style="font-family: Montserrat; color: gray;">No notifications yet.</p>
                        <?php endif; ?>    
                    </div>
                </div>
                </div>
